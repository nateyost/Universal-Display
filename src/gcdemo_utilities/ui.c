...
//                    uiCallback_setScrollSpeedFast();
//                }
//                else
//                {
//                    uiCallback_setScrollSpeedSlow();
//                }
//                if(p->submenu_using_lr == 1)
//                {
...
//                p->p_lcd->iconALL = 0;
//                p->menu_state++;
//                p->menu_state = arraySafeIndex(p->menu_state_max,0,p->menu_state);
//                p->menu();
//
